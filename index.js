...
autoketik = false;
prefixStatus = true;
targetpc = "6282322427684";
owner = "6282322427684";
namabot = "M E E X Y-BOT";
fakeyoi = "M E E X Y";
HunterApi = "Ikyy69",
valkey = "rivalgans",
dapapi = "itsmevall",
nomorowner1 = "@6282322427684";
fake = `© M e e x y`;
...
await itsmevall.updatePresence(from, Presence.composing)
    ...
    const ownerNumber = [`6282322427684@s.whatsapp.net`]
...
const reply = (teks) => {
			itsmevall.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `© M E E X Y`,body:"",previewType:"PHOTO",thumbnail:bgg,sourceUrl:`https://wa.me/6282322427684?text=Hello bro`}}})
		}
    ...
    const ftroli = {
      key: {
        ...
        remoteJid: "6282322427684-1604595598@g.us",
      },
      message: {
        orderMessage: {
          itemCount: 10,
...
const finv = {
	...
	"message": {
		"groupInviteMessage": {
			"groupJid": "6282322427684-1616169743@g.us",
...
const fview = {
    ...
    const fvn = {
      key: {
        participant: `0@s.whatsapp.net`,
        ...(from ? { remoteJid: "6282322427684-1613049930@g.us" } : {}),
      },
      message: {
        audioMessage: {
...
"key": {
	  "participant": `0@s.whatsapp.net`,
      "remoteJid": "6282322427684-1613049930@g.us",
      "fromMe": false,
      ...
      itsmevall.sendMessage(from, teks, text, {
        quoted: {
          key: {
            fromMe: false,
            participant: `0@s.whatsapp.net`,
            ...(from ? { remoteJid: "6282322427684-1604595598@g.us" } : {}),
          },
          message: {
            imageMessage: {
              url: "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc",
      ...
      message: {
        productMessage: {
          product: {
            ...
            description: "M E E X Y BOT",
            currencyCode: "USD",
            priceAmount1000: "2000",
            retailerId: "M E E X Y",
            productImageCount: 1,
          },
...
itsmevall.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    const add = function (from, orangnya) {
      itsmevall.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	grup = itsmevall.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6282322427684-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/FpE1TXXUzuk0TASzYwX8ZM', "groupName": `M E E X Y-Bot Inc.`, "footerText": "*_© M E E X Y_*", "jpgThumbnail": iye, "caption": teks}}, {quoted:mek})
...
sendEphemeral: false,
"externalAdReply": {
                "title": `M E E X Y. (@dani_studento) • Follow Instagram and Like Videos`,
                "body": "",
                "previewType": "PHOTO",
                "thumbnailUrl": "https://i.postimg.cc/nrwprvSB/IMG-20211024-011856.jpg",
                "thumbnail": fake,
                "sourceUrl": ``
...
"externalAdReply": {
                "title": `Whatsapp`,
                "body": `wa.me/6282322427684`,
                "mediaType": "10",
                "mediaUrl": `wa.me/6282322427684`,
                "thumbnailUrl": "https://i.postimg.cc/nrwprvSB/IMG-20211024-011856.jpg",
                "thumbnail": iye,
                "sourceUrl": `wa.me/6282322427684`,
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "6282322427684@s.whatsapp.net";
...
case 'help':
case 'menu':
       txtt =`${ucapanWaktu} *${pushname}*\n*Butuh bantuan?* Silahkan pakai Fitur yang ada di *M E E X Y-BOT*`
...
® M E E X Y`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
buttons = [{buttonId:`${prefix}owner`,buttonText:{displayText: 'OWNER BOT'},type:1},{buttonId:`${prefix}ping`,buttonText:{displayText:'SPEED TEST'},type:1},{buttonId:`${prefix}rules`,buttonText:{displayText:'PERATURAN'},type:1}]
               ...
               buttonsMessage = {
               contentText: `${menu1}`,
               footerText: `© 𝑪𝒓𝒆𝒂𝒕𝒆𝒅 𝒃𝒚 M E E X Y
Fitur ini di Recode asli oleh M e e x y
IG : https//www.instagram.com/dani_studento`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
prep = await itsmevall.prepareMessageFromContent(from,{buttonsMessage},{quoted: mek})
...
break
case 'iggw':
  reply('https://www.instagram.com/dani_studento')
break
      /*case "owner":
        sendKontak(from, owner, "meexy gans", "Busy");*/
             case 'setprofile':
			case 'setpp':
...
case 'owner':
           case 'creator':
               ...
               buttonsMessage = { contentText: `${haibg}`, footerText: '© M E E X Y', buttons: buttons, headerType: 1 }
               prep = await itsmevall.prepareMessageFromContent(from,{buttonsMessage},{quoted: fgif})
               itsmevall.relayWAMessage(prep)
               break      
              case 'dice':
...
break;
      ...
      //------------------< Group Features >-------------------
      case "listonline": //code by M E E X Y
       ...
       case 'matpel':
         ...
         case 'rabu':
          ...
          case 'jumat':
              ...
              break
           case 'sabtu':
ruls =`*• M E E X Y Menyatakan bahwa :*
...
buttonsMessage = { contentText: `${ruls}`, footerText: '© M E E X Y\n*Semangat Belajarnya!*', buttons: buttons, headerType: 1 }
prep = await itsmevall.prepareMessageFromContent(from,{buttonsMessage},{quoted: fgif})
itsmevall.relayWAMessage(prep)
break
       // Set Profile Group
...
case 'ytgw':
  reply('https://youtube.com/c/M E E X Y')
					break;
   case 'ss':
      reply(mess.wait)
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          ...
          "url": "https://github.com/DGM E E X Y"
        },
        "index": 0
      }
    ]
...
case "asupan3": // by M E E X Y
  ...
  case 'write': case 'writeabook':            
            if (args.length == 0) return reply(`contoh: ${prefix + command} M E E X Y`)
            reply(mess.wait)
            teks = args.join(" ")
...
*Bot Grup :* https://chat.whatsapp.com/
© 𝑪𝒓𝒆𝒂𝒕𝒆𝒅 𝒃𝒚 M E E X Y`
             replyfakelink(teks)
             break;
      case "totag":
        if (
...
itsmevall.sendMessage(from, stdout, text, term)
      ...
      default:
		if (hour_now >= '02:00' && hour_now <= '04:00') {
          console.log(color('[Bot Message]', 'cyan'), color('Subscribe M E E X Y', 'yellow'), color('(🗿)', 'white'))
          }
        ...
        if (hour_now >= '06:00' && hour_now <= '11:00') {
          console.log(color('[Bot Message]', 'cyan'), color('Susbcribe M E E X Y', 'yellow'), color('(🗿)', 'white'))
          }
...
itsmevall.sendMessage(from, Peli, MessageType.sticker, {quoted: mek})
    ...
    if (isGroup && budy != undefined) {
      ...
      console.log(
        color("[SELFBOT]", "red"),
        "Self Bot By M E E X Y",
        color(sender.split("@")[0])
      );
    }
   } catch (e) {
    e = String(e);// fixed fromMe by M E E X Y
